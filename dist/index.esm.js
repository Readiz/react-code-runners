...
function Button(_a) {
    ...
    return (React.createElement("button", __assign({ style: __assign(__assign({}, buttonStyle), (props.disabled ? disabledStyle : {})), className: className }, props), children));
}
...
function Textarea(_a) {
    ...
    return (React.createElement("textarea", __assign({ style: textareaStyle, className: className }, props)));
}
...
function Card(_a) {
    ...
    return (React.createElement("div", { style: cardStyle, className: className }, children));
}
function CardHeader(_a) {
    ...
    return (React.createElement("div", { style: headerStyle, className: className }, children));
}
function CardTitle(_a) {
    ...
    return (React.createElement("h3", { style: titleStyle, className: className }, children));
}
function CardContent(_a) {
    ...
    return (React.createElement("div", { style: contentStyle, className: className }, children));
}
...
var MonacoEditor$1 = dynamic(function () { return import('@monaco-editor/react'); }, { ssr: false });
function CppRunner(_a) {
    ...
    var _f = useState(initialCode), code = _f[0], setCode = _f[1];
    var _g = useState(initialStdin), stdin = _g[0], setStdin = _g[1];
    var _h = useState(''), output = _h[0], setOutput = _h[1];
    var _j = useState(false), isLoading = _j[0], setIsLoading = _j[1];
    var _k = useState(false), isCompiling = _k[0], setIsCompiling = _k[1];
    var _l = useState(null), executionTime = _l[0], setExecutionTime = _l[1];
    ...
    return (React.createElement(Card, { className: "rounded-md shadow-sm border" },
        showTitle && (React.createElement(CardHeader, { className: "px-3 pb-2" },
            React.createElement(CardTitle, null, title))),
        React.createElement(CardContent, { className: "px-3 ".concat(showTitle ? 'pt-0' : 'pt-3') },
            React.createElement("div", { className: "space-y-4" },
                React.createElement("div", null,
                    React.createElement("label", { htmlFor: "code", className: "block text-sm font-medium mb-1" }, "C++ \uCF54\uB4DC"),
                    React.createElement("div", { className: "border rounded-md overflow-hidden" },
                        React.createElement(MonacoEditor$1, { height: "400px", language: "cpp", value: code, theme: "vs-dark", onChange: function (value) { return setCode(value || ''); }, options: {
                ...
                React.createElement("div", null,
                    React.createElement("label", { htmlFor: "stdin", className: "block text-sm font-medium mb-1" }, "\uD45C\uC900 \uC785\uB825"),
                    React.createElement(Textarea, { id: "stdin", value: stdin, onChange: function (e) { return setStdin(e.target.value); }, placeholder: "\uD45C\uC900 \uC785\uB825\uC744 \uC785\uB825\uD558\uC138\uC694", className: "min-h-[80px] font-mono" })),
                React.createElement(Button, { onClick: handleRun, disabled: isLoading }, isLoading ? (isCompiling ? '컴파일 중...' : '실행 중...') : '실행'),
                React.createElement("div", null,
                    React.createElement("label", { htmlFor: "output", className: "block text-sm font-medium mb-1" }, "\uD45C\uC900 \uCD9C\uB825"),
                    React.createElement("div", { id: "output", className: "bg-gray-100 p-4 rounded-md min-h-[80px]" },
                        React.createElement("pre", { className: "whitespace-pre-wrap" }, output),
                        executionTime !== null && (React.createElement("div", { className: "mt-2 text-sm text-gray-500 border-t border-gray-200 pt-2" },
                            "\uC2E4\uD589 \uC2DC\uAC04: ",
...
// Monaco 에디터를 동적으로 불러오기 (SSR 방지)
var MonacoEditor = dynamic(function () { return import('@monaco-editor/react'); }, { ssr: false });
function PythonRunner(_a) {
    ...
    var _h = useState(''), output = _h[0], setOutput = _h[1];
    var _j = useState(false), isLoading = _j[0], setIsLoading = _j[1];
    var _k = useState(null), executionTime = _k[0], setExecutionTime = _k[1];
    var handleRun = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return (React.createElement(Card, { className: "rounded-md shadow-sm border" },
        ...
        React.createElement(CardContent, { className: "px-3 ".concat(showTitle ? 'pt-0' : 'pt-3') },
            React.createElement("div", { className: "space-y-4" },
                React.createElement("div", null,
                    React.createElement("label", { htmlFor: "code", className: "block text-sm font-medium mb-1" }, "Python \uCF54\uB4DC"),
                    React.createElement("div", { className: "border rounded-md overflow-hidden" },
                        React.createElement(MonacoEditor, { height: "400px", language: "python", value: code, theme: "vs-dark", onChange: function (value) { return setCode(value || ''); }, options: {
                                minimap: { enabled: false },
                                scrollBeyondLastLine: false,
                                fontSize: 14,
                                automaticLayout: true,
                ...
                React.createElement("div", null,
                    React.createElement("label", { htmlFor: "stdin", className: "block text-sm font-medium mb-1" }, "\uD45C\uC900 \uC785\uB825"),
                    React.createElement(Textarea, { id: "stdin", value: stdin, onChange: function (e) { return setStdin(e.target.value); }, placeholder: "\uD45C\uC900 \uC785\uB825\uC744 \uC785\uB825\uD558\uC138\uC694", className: "min-h-[80px] font-mono" })),
                React.createElement(Button, { onClick: handleRun, disabled: isLoading }, isLoading ? '실행 중...' : '실행'),
                React.createElement("div", null,
                    React.createElement("label", { htmlFor: "output", className: "block text-sm font-medium mb-1" }, "\uD45C\uC900 \uCD9C\uB825"),
                    React.createElement("div", { id: "output", className: "bg-gray-100 p-4 rounded-md min-h-[80px]" },
                        React.createElement("pre", { className: "whitespace-pre-wrap" }, output),
